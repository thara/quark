...
func (c *roomClient) CreateRoom(ctx context.Context, in *CreateRoomRequest, opts ...grpc.CallOption) (*CreateRoomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/quark.gameserver.Room/CreateRoom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roomClient) Service(ctx context.Context, opts ...grpc.CallOption) (Room_ServiceClient, error) {
	stream, err := c.cc.NewStream(ctx, &Room_ServiceDesc.Streams[0], "/quark.gameserver.Room/Service", opts...)
	if err != nil {
		return nil, err
	}
...
func _Room_CreateRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/quark.gameserver.Room/CreateRoom",
	}
...
var Room_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "quark.gameserver.Room",
	...
	Metadata: "proto/gameserver/room.proto",
}
